          ...
          <table className="w-full min-w-[750px]">
            <thead>
              <tr className="border-b border-slate-100 dark:border-slate-600 bg-slate-50 dark:bg-slate-700/50">
                ...
                {isOps && <th className="text-left px-4 py-3 text-xs font-semibold uppercase tracking-widest text-slate-400 dark:text-slate-300">Store</th>}
            ...
            <tbody>
              {userList.length === 0 && (
                <tr>
                  <td colSpan={isOps ? 6 : 5} className="px-5 py-12 text-center text-slate-400 dark:text-slate-400 text-sm">
